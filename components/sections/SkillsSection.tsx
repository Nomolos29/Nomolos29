  ...
  return (
    <section className="w-full py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Certifications */}
        <div className="bg-gradient-to-r from-blue-50 to-blue-100/50 rounded-2xl p-8">
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="px-8 py-3 border-2 border-blue-600 text-blue-600 font-semibold rounded-full hover:bg-blue-50 transition-colors">
              Let&apos;s Connect
            </button>
          </div>
        </div>
