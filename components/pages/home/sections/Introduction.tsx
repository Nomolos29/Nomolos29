...
const Introduction = () => {
  return (
    <section className='w-full flex justify-center py-14 bg-gradient-to-b md:from-[20%] to-60% from-gray-700 to-white px-5 md:px-8 lg:px-10 xl:px-14'>
        <div className='max-w-[1440px] flex flex-col items-center'>
            ...
            <div className='w-full flex flex-col md:flex-row justify-between py-20 gap-5 lg:gap-10'>
                <div className='md:w-[48%] lg:w-3/10 flex flex-col gap-y-5 justify-between'>
                    <h2 className='text-5xl md:text-7xl font-[family-name:var(--font-poppins)]'>Building Digital <span className='text-[#f835a7]'>Products</span> that <span className='text-primary'>Scale</span>.</h2>
                    <p className='pr-3 text-lg'> Regardless of the technology, my focus has always remained creating products that are intuitive, scalable, and built with long-term maintainability in mind.</p>

                    <div className='hidden md:block py-7 px-7 md:pl-5 ld:pl-10 bg-gradient-to-r mt-5 lg:w-[216%] xl:w-[228%] rounded-2xl from-[20%] to-60% from-gray-200 to-gray-50 relative'>
                        <div className='w-[95%] md:w-4/5'>
                            <p className='text-lg'>Beyond writing code, I think like a product builder. I care deeply about user experience, performance, accessibility, and creating solutions that solve real business problems rather than simply delivering features.</p>
                            <Link
                ...
                <div className='w-full md:w-[45%] h-full lg:w-[70%] flex flex-col lg:flex-row lg:justify-between gap-5 lg:gap-10'>
                    <div className='w-full lg:w-[48%] h-[450px] md:h-[400px] lg:h-[450px] bg-white rounded-2xl shadow-[10px_10px_20px_rgba(0,0,0,0.2)]'>
                    ...
                    <div className='w-full lg:w-[48%] flex flex-col gap-y-10 relative mt-14 md:mt-8 lg:m-0'>
                        ...
                        <div className='w-full h-[650px] md:h-[230px] lg:h-[600px] xl:h-[630px] bg-white relative overflow-hidden rounded-2xl shadow-[10px_10px_20px_rgba(0,0,0,0.2)]'>
                            ...
                            <div className='top-10 flex md:hidden lg:flex'>
                                <Link href="https://www.schickcollections.com/" target='_blank'> <Image src="/homepage/schickcollection-homepage.png" alt='acedboard value tracker section mockup' width={1000} height={400} className='object-fit shadow-[-10px_10px_20px_rgba(0,0,0,0.2)] absolute top-[45%] md:top-[55%] left-1 bg-no-repeat' /></Link>
                ...
                <div className='block md:hidden py-7 px-7 md:pl-5 ld:pl-10 bg-gradient-to-r mt-5 lg:w-[216%] xl:w-[228%] rounded-2xl from-[20%] to-60% from-gray-200 to-gray-50 relative'>
                    <div className='w-[95%] md:w-4/5'>
                        <p className='text-lg'>Beyond writing code, I think like a product builder. I care deeply about user experience, performance, accessibility, and creating solutions that solve real business problems rather than simply delivering features.</p>
                        <Link
                            href={'https://wa.me/+2348101123098'}
