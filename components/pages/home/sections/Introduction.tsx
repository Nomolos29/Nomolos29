    ...
    <section className='w-full flex justify-center py-14 bg-gradient-to-b from-[20%] to-60% from-gray-700 to-white px-14'>
        <div className='max-w-[1440px] flex flex-col items-center'>
            ...
            <div className='w-full flex py-20 gap-10'>
                ...
                <div className='w-[35%] h-[450px] bg-white rounded-2xl shadow-[10px_10px_20px_rgba(0,0,0,0.2)]'>
                ...
                <div className='w-[35%] flex flex-col gap-y-10 relative overflow-hidden'>
                    ...
                    <div className='w-full h-[650px] bg-white overflow-hidden rounded-2xl shadow-[10px_10px_20px_rgba(0,0,0,0.2)]'>
